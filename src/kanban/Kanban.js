...
// import { createTask } from "../Features/taskManagementSlice";

function Kanban() {
  // const tasksAdded = useSelector((state) => state.taskManagement);
  // const dispatch = useDispatch();
  // console.log("redux", tasksAdded.tasks);
  ...
  const logout = () => {
    ...
    localStorage.removeItem("statusboard");
    navigate("./login");
  };

  useEffect(() => {
    // dispatch(createTask("Hello"));
  ...
  return (
    <div className="kanban">
      <div className="kanban_nav">
        <h1 className="kan_title">Kanban Board</h1>
